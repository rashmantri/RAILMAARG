	...
	<div class="wrap">
		...
		<div class="span12 well">
				...
				<form method="get" action="booking.php">
					...
					<table class="table" style="border-style:ridge;">
						...
						<tr>
							...
							<input name="doj" style="display:none;" type="text"
								value="<?php echo isset($_GET['doj']) ? $_GET['doj'] : ''; ?>">
							<td style="border-top:0px;">
								<?php echo isset($_GET['doj']) ? $_GET['doj'] : ''; ?>
							</td>
							<input name="dob" style="display:none;" type="text" value="<?php echo date("Y-m-d"); ?>">

							<input name="tno" style="display:none;" type="text"
								value="<?php echo isset($_GET['tno']) ? $_GET['tno'] : ''; ?>">
							</td>
							<td style="border-top:0px;">
								<?php echo isset($_GET['tno']) ? $_GET['tno'] : ''; ?>
							</td>
							<td style="border-top:0px;">
								<?php echo isset($_GET['fromstn']) ? $_GET['fromstn'] : ''; ?>
							</td>
							<input name="fromstn" style="display:none;" type="text"
								value="<?php echo isset($_GET['fromstn']) ? $_GET['fromstn'] : ''; ?>"> </td>

							<td style="border-top:0px;">
								<?php echo isset($_GET['tostn']) ? $_GET['tostn'] : ''; ?>
							</td>
							<input name="tostn" style="display:none;" type="text"
								value="<?php echo isset($_GET['tostn']) ? $_GET['tostn'] : ''; ?>">
							</td>

							<td style="border-top:0px;">
								<?php echo isset($_GET['quota']) ? $_GET['quota'] : ''; ?>
							</td>
							<input name="quota" style="display:none;" type="text"
								value="<?php echo isset($_GET['quota']) ? $_GET['quota'] : ''; ?>">
							</td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="1A"
									onclick="return false;" <?php if (isset($_GET['class']) && $_GET['class'] == '1A') {
										echo 'checked';
									} ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="2A"
									onclick="return false;" <?php if (isset($_GET['class']) && $_GET['class'] == '2A') {
										echo 'checked';
									} ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="3A"
									onclick="return false;" <?php if (isset($_GET['class']) && $_GET['class'] == '3A') {
										echo 'checked';
									} ?>> </td>

							<td style="border-top:0px;"> <input type="radio" name="selct" value="SL"
									onclick="return false;" <?php if (isset($_GET['class']) && $_GET['class'] == 'SL') {
										echo 'checked';
									} ?>> </td>
						</tr>
					</table>
			...
			<div class="display" style="margin-top:0px;height:415px;">
				<h2>
					<font color="blue">Passenger Detail</font>
				</h2>
			...
			<div>
				<br />
				<p>
					<font color="red"> CHILDREN BELOW 5 YEAR (FOR WHOM TICKET IS NOT TO BE ISSUED). </font>
				</p>
			</div>
